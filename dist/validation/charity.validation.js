...
exports.updateCharitySchema = exports.createCharitySchema = void 0;
const zod_1 = require("zod");
const auth_validation_1 = require("./auth.validation");
const file_validation_1 = require("./file.validation");
const user_validation_1 = require("./user.validation");
exports.createCharitySchema = auth_validation_1.registerSchema.extend({
...
exports.updateCharitySchema = user_validation_1.updateUserProfileSchema.extend({
    workPermitImage: file_validation_1.imageSchema.optional(),
    workPermitFile: file_validation_1.fileSchema.optional(),
